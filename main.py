    ...
    with psycopg2.connect(database=database, user=user, password=password) as conn:
        with conn.cursor() as curs:
            ...
            print("Добавлен клиент id: ",
                  insert_client(curs, "Антон", "Чехов", "Chekh715@gmail.com"))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Кирилл", "Мефодиев",
                                "vubx0t@mail.ru", 79993318655))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Парамон", "Петров",
                                "c0pu@outlook.com", 79933314633))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Емельян", "Пугачёв",
                                "k8sjebg1y@mail.ru", 79913312628))
            print("Добавлена клиент id: ",
                  insert_client(curs, "Карл", "Кораллов",
                                "Karl@outlook.com"))
            ...
            pprint(find_client(curs, 'Парамон'))

            print('Найденный клиент по email:')
            pprint(find_client(curs, None, None, 'Karl@outlook.com'))

            print('Найденный клиент по фамилии:')
            pprint(find_client(curs, None, 'Пугачёв',
                               None))

            print('Найденный клиент по телефону:')
            pprint(find_client(curs, None, None, None, '79913312628'))
